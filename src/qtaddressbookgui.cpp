...
void QtAddressBookGUI::createWidgets()
{
    ...
    //list-> setStyleSheet("color: black;"
                               // "font: bold 14px");
    detailView-> setStyleSheet("color: blue;"
                                "font: bold 10px");

    newContactButton = new QPushButton("New Contact");
    newContactButton-> setStyleSheet("color: black;"
                                "font: bold 14px");

    editContactButton = new QPushButton("Edit");
    editContactButton->setStyleSheet("color: black;"
                                    "font: bold 14px");
    deleteContactButton = new QPushButton("Delete");
    deleteContactButton->setStyleSheet("color: black;"
                                    "font: bold 14px");
...
void QtAddressBookGUI::delete_sure()
{
 //   QMessageBox msgbox;
   // msgbox.setInformativeText("Are you Sure to delete..");
   // msgbox.standardButton();
    QMessageBox::StandardButton reply;
      reply = QMessageBox::question(this, "Delete", "Are you sure you want to delete?",
                                    QMessageBox::Yes|QMessageBox::No);
      if (reply == QMessageBox::Yes) {
          connect(deleteContactButton, SIGNAL(clicked()),this, SLOT(deleteContact()));
        //QApplication::quit();
      } else {
     //   QApplication::quit();
      }
